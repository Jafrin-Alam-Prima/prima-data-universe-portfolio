/* ═══════════════════════════════════════════════════════════════
   PRIMA'S DATA UNIVERSE — Main Script
   ═══════════════════════════════════════════════════════════════ */
...
(function () {
    ...
    async function fetchGitHubRepos() {
        ...
        try {
            const resp = await fetch('https://api.github.com/users/Jafrin-Alam-Prima/repos?sort=updated&per_page=12');
            if (!resp.ok) throw new Error('API error');
            const repos = await resp.json();
            const featured = ['libraal', 'zerowaste', 'pc-build', 'supply-chain', 'bloodsupport'];
    ...
    function initAIAssistant() {
        ...
        const KB = {
            identity: {
                keywords: ['who', 'prima', 'jafrin', 'about', 'introduce', 'tell me about', 'herself', 'background', 'bio'],
                answer: `<strong>Jafrin Alam Prima</strong> is a Software Engineering graduate majoring in <em>Data Science</em> from Daffodil International University, Dhaka, Bangladesh. She's passionate about AI, data analytics, and building intelligent systems for social impact. 🚀`
            },
            projects: {
                keywords: ['project', 'built', 'portfolio', 'work', 'develop', 'libra', 'zerowaste', 'blood', 'supply chain', 'pc build', 'innovation'],
                answer: `Prima has built several impactful projects:<br>
                    ...
                    🔹 <strong>Supply Chain Intelligence</strong> — Power BI analytics dashboard<br>
                    🔹 <strong>PC Build Simulator</strong> — Spring Boot + MySQL app<br>
            ...
            awards: {
                ...
                answer: `Prima has an impressive achievement record! 🏆<br>
                    🌍 <strong>Global Nominee</strong> — NASA Space Apps 2025 (11,500+ projects)<br>
                    🥈 <strong>2nd Runner-Up</strong> — NASA Space Apps 2025<br>
                    🥇 <strong>1st Runner-Up</strong> — DIU Agentic AI Excellence Award<br>
                    🏅 <strong>Champion</strong> — National Data Science Summit<br>
                    🏁 <strong>Finalist</strong> — Programming Hero National Hackathon<br>
                    🌌 <strong>Galactic Problem Solver</strong> — NASA Space Apps 2024<br>
            ...
            skills: {
                ...
                answer: `Prima's key skills include:<br>
                    ...
                    ☕ <strong>Java</strong> — Advanced (880 XP)<br>
                    🤖 <strong>Machine Learning</strong> — Intermediate (820 XP)<br>
                    🧠 <strong>AI Engineering</strong> — Intermediate<br>
            ...
            research: {
                ...
                answer: `Prima's research interests include:<br>
                    ...
                    She envisions AI as a transparent partner for humanitarian impact. 🌍`
            },
            education: {
                ...
                answer: `🎓 <strong>B.Sc. in Software Engineering</strong><br>
                    ...
                    Her academic journey blends software engineering with deep data science specialization. 📚`
            },
            experience: {
                keywords: ['experience', 'work', 'job', 'career', 'outlier', 'save the children', 'trainer', 'analyst', 'professional', 'employ'],
                answer: `Prima's professional experience:<br>
                    💼 <strong>Trainee Data Analyst</strong> — Save the Children International (Jan 2026 – Present)<br>
                    Working on real-world data analysis, business insights & reporting.<br><br>
                    🤖 <strong>AI Trainer</strong> — Outlier (Jul 2024 – Jun 2025)<br>
            ...
            certifications: {
                ...
                answer: `Prima holds certifications from top platforms:<br>
                    Ⓜ️ Microsoft — AI Champion for Nonprofits<br>
                    🏷️ Google Kaggle — AI Agents Intensive Course<br>
                    ☁️ AWS — ML for NLP & ML Foundations<br>
                    🧠 DeepLearning.AI — Supervised ML<br>
                    📘 Coursera — Azure ML, Business Analysis & more 📜`
            },
            leadership: {
                keywords: ['leadership', 'leader', 'vice president', 'convener', 'club', 'basis', 'community', 'organize', 'workshop'],
                answer: `Prima takes active leadership roles:<br>
                    🌟 <strong>Vice President</strong> — Data Science Club, DIU<br>
                    🤝 <strong>Co-Convener</strong> — BASIS Students Forum<br>
                    She organizes workshops, connects students with industry, and promotes data science education. 👑`
            },
            contact: {
                keywords: ['contact', 'email', 'phone', 'reach', 'connect', 'linkedin', 'github', 'hire', 'message'],
                answer: `📧 <strong>Email:</strong> ja.prima07@gmail.com<br>
                    📱 <strong>Phone:</strong> 01761081870<br>
                    💼 <a href="https://www.linkedin.com/in/jafrin-alam-prima/" target="_blank">LinkedIn</a> | 
                    🐙 <a href="https://github.com/Jafrin-Alam-Prima" target="_blank">GitHub</a><br>
                    📍 Dhaka, Bangladesh 🇧🇩`
            },
            greeting: {
                keywords: ['hi', 'hello', 'hey', 'good', 'morning', 'evening', 'afternoon', 'sup', 'yo'],
                answer: `Hello, explorer! 👋 Welcome to Prima's Data Universe. I can tell you about her <strong>projects</strong>, <strong>awards</strong>, <strong>skills</strong>, <strong>research interests</strong>, <strong>education</strong>, or <strong>experience</strong>. What would you like to know? 🚀`
            }
        };
        ...
        function getAnswer(q) {
            ...
            return `Hmm, that's beyond my star charts! 🌌 Try asking about Prima's <strong>projects</strong>, <strong>awards</strong>, <strong>skills</strong>, <strong>research</strong>, <strong>education</strong>, or <strong>experience</strong>.`;
        }
    }
    ...
    function updateProgress() {
        ...
        if (discovered.size === PLANETS.length && !localStorage.getItem('allDiscovered')) {
            ...
            setTimeout(() => {
                showToast('🌟 Universe Master!', "You explored every planet in Prima's Data Universe!");
                playChime();
            }, 1000);
        }
    }
